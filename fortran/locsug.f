      subroutine LOCSUG(n,m,ndimn,tanret,choret,coor,x,
     1                  ug ,vg ,u10,u20,v10,v20,r,z,dist,imes)
      implicit none
      integer*8 i,i0,id,imes,ispa,iter,j,j0,m,miter,n,ndimn
      real*8 apatch(5,4,4),aps(1),beta,bk,choret(2,n,m),coor(ndimn,*)
      real*8 da,dist,eps1,eps2,eps3,gg(2),h(2),h0(2),h11,h12,h22
      real*8 r(*),ru(5),ruu(5),ruv(5),rv(5),rvv(5)
      real*8 tanret(ndimn,3,n,m),u,u1,u10,u2,u20,ug,ug0,v,v1,v10
      real*8 v2,v20,vg,vg0,x(*),xd,xden,xgr1,xgr2,xl,xpp,z(*)
      parameter(eps1=0.001d0,eps2=0.00001d0,eps3=0.001d0)
      parameter(miter=100)
c
...
c associated with a GCGM.                    The search is limited in the
...
c
      bk = (xgr1-h0(1))*xgr1+(xgr2-h0(2))*xgr2
      bk = bk/(h0(1)**2+h0(2)**2)
      h0(1)=xgr1
      h0(2)=xgr2
      h(1) = -xgr1 +bk*h(1)
...
50    continue
      ...
      da = -0.5d0*(xgr1*h(1)+xgr2*h(2))/xden
c
c limit step
c
